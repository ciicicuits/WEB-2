...
<body style="font-size: 18px;">
    <form method="POST" action="nilai_mahasiswa.php" class="container mt-5">
    <fieldset class="border border-dark p-3 rounded" style="background-color: lightyellow;">
        <legend class="border border-dark float-none w-auto px-3 fw-bold h3" style="background-color: lightgrey;">Form Nilai Siswa</legend>
