...
$query = "SELECT p.*, pr.nama_produk, pr.harga, a.nama AS nama_anggota
          FROM pemesanan p
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a href="pemesanan_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus data ini?')">Hapus</a>
        </td>
      </tr>
      <?php endforeach; ?>
    </tbody>
